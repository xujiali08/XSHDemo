...
extension Date{
    ...
    func isThisWeek() -> Bool {
        return self.isSameWeek(aDate: Date())
    }
    ...
    //判断是否为同一月
    func isSameMonth(aDate : Date) -> Bool {
        let components1 = calendar.dateComponents(unitFlags, from: self as Date)
        let components2 = calendar.dateComponents(unitFlags, from: aDate)
    ...
    //从某时间起几天后
    func dateWithDaysAfter(days: Double) -> Date {
        let aTimeInterval = self.timeIntervalSinceReferenceDate + days * D_DAY - 1
        let newDate = Date(timeIntervalSinceReferenceDate: aTimeInterval)
        return newDate
    }
    ...
    static func yearFormatString() -> String {
        return "yyyy年"
    }
    ...
    static func secondFormatString() -> String {
        return "HH:mm:ss"
    }
    ...
    static func datesBiasFormatString() -> String {
        return "yyyy/MM/dd HH:mm"
    }
    static func dateBiasFormatString() -> String {
        return "yyyy/MM/dd"
    }
    ...
    static func datePointFormatString() -> String {
        return "yyyy.MM.dd"
    }
